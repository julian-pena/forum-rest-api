...
@Component
public class ResponseByTopicSearchCriteria implements ResponseSearchCriteria {

    private final ResponseRepository responseRepository;

    @Autowired
    public ResponseByTopicSearchCriteria(ResponseRepository responseRepository){
    ...
    public Page<Response> applyCriteria(Pageable pageable, String value) {
        return responseRepository.findByTopicTitleContainingIgnoreCase(value, pageable);
    }
}
