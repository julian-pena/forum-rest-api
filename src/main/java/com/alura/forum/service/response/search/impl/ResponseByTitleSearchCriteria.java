...
@Component
public class ResponseByTitleSearchCriteria implements ResponseSearchCriteria {

    private final ResponseRepository responseRepository;

    @Autowired
    public ResponseByTitleSearchCriteria(ResponseRepository responseRepository){
    ...
    public Page<Response> applyCriteria(Pageable pageable, String value) {
        return responseRepository.findByMessageContainingIgnoreCase(value, pageable);
    }
}
